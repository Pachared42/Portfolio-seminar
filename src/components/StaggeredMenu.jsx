            ...
            >
                ...
                >
                    ...
                    >
                        <span
                            ref={textWrapRef}
                            className="sm-toggle-textWrap relative inline-block h-[1em] overflow-hidden whitespace-nowrap w-(--sm-toggle-width,auto)w-[var(--sm-toggle-width,auto)]"
                            aria-hidden="true"
                        >
                        ...
                        >
                            <span
                                ref={plusHRef}
                                className="sm-icon-line absolute left-1/2 top-1/2 w-full h-0.5g-current rounded-xs -translate-x-1/2 -translate-y-1/2 will-change-transform"
                            />
                            <span
                                ref={plusVRef}
